...
class StoreRegionDelete extends AdminDBDelete
{
    ...
    protected function processDBData(): void
    {
        ...
        $message = new SwatMessage(sprintf(Store::ngettext(
            'One region has been deleted.',
            '%s regions have been deleted.',
            $num
    ...
    public function buildInternal()
    {
        ...
        $sql = sprintf(
            'select count(distinct Item.product) as count,
        ...
        $summaries = SwatDB::query(
            $this->app->db,
            $sql,
            SwatDBClassMap::get(AdminDependencySummaryWrapper::class)
        );
