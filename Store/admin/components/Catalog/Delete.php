...
class StoreCatalogDelete extends AdminDBDelete
{
    ...
    protected function processDBData(): void
    {
        ...
        if ($this->catalogIsEnabled()) {
            $sql = sprintf(
                'delete from Catalog where id = %s
        ...
        $message = new SwatMessage(sprintf(
            Store::_('One %s has been deleted.'),
            Store::_('catalog')
        ), 'notice');
    ...
    {
        return sprintf(
            Store::_('A %s must contain no products, or be ' .
     ...
     *
     * @return bool true if any of the catalogues are enabled and false if
