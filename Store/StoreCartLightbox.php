...
class StoreCartLightbox extends SwatControl
{
    ...
    public function __construct(
        ...
        $mobile_close->classes = 'button store-close-cart mobile-only';
    ...
    protected function getInlineJavaScript()
    {
        ...
        if (!$translated) {
            $javascript .= sprintf(
                "StoreCartLightbox.empty_content = %s;\n",
                SwatString::quoteJavaScriptString($this->empty_content)
            );

            $javascript .= sprintf(
                "StoreCartLightbox.loading_message = %s;\n",
            ...
            $javascript .= sprintf(
                "StoreCartLightbox.submit_message = %s;\n",
    ...
    protected function getCartTitle()
    {
        ...
        if ($item_count > 0) {
            $items = sprintf(
                ...
                sprintf(
                    Store::ngettext('%s item', '%s items', $item_count),
