...
$package->addPackageDepWithChannel('required', 'Site', 'pear.silverorange.com', '1.1.12');
$package->addPackageDepWithChannel('required', 'Admin', 'pear.silverorange.com', '1.1.26');
