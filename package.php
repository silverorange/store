...
$package->addPackageDepWithChannel('required', 'Site', 'pear.silverorange.com', '1.2.12');
$package->addPackageDepWithChannel('required', 'Admin', 'pear.silverorange.com', '1.3.0');
